...
Classe que tem dois métodos, um para formatar CNPJ e outro pra formatar CPF, geralmente uso quando baixo dados do Sistema Nacional de Cadastro Rural - SNCR onde a tabela exportada necessita de ajustes na formatação antes de utilizar os dados em análises.
